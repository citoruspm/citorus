...
Откроется карточка создаваемого контейнера (рис. 2), в которой необходимо заполнить поле **Название**. Чтобы сохранить контейнер, на
...
на рис. 5). Заполните в карточке требуемые поля и на панели инструментов нажмите на кнопку **Сохранить** |image6|. Объект отобразится в выбранном контейнере.
...
1. Кнопки:
   ...
   -  **Сохранить как** |image109| – предназначена для создания копии текущей категории объекта. Копия помещается в тот же контейнер, в
   котором находится прототип. При выполнении команды **Сохранить как** открывается диалоговое окно, в котором необходимо указать название копии.
...
|                | **Создать**, расположенную над таблицей                                                |
|                |(см. раздел `Табличное представление объектов системы`_).                               |
+----------------+----------------------------------------------------------------------------------------+
...
1. Слово без символов масок, например, **система**, будет воспринято, как указание найти все слова, начинающиеся с **система**. Будут найдены такие слова как «*система*тический», «*система*тизированный» и т.д.
